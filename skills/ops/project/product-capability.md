...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when you need to convert vague planning prose into a durable engineering contract before coding begins.
---
...
- You need a reusable artifact that can survive across sessions
...
- The resulting plan is reusable across different tooling and planning surfaces.
