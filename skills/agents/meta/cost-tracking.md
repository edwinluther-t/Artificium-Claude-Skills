---
name: cost-tracking
description: Track and report Claude Code token usage, spending, and budgets from the local cost-tracker metrics log. Use when the user asks about costs, spending, usage, tokens, budgets, or cost breakdowns by model, session, or date.
---

# Cost Tracking

Use this skill to analyze Claude Code cost and usage history from the metrics log written by a `stop:cost-tracker` hook.
