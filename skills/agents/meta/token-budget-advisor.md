...
description: Offers the user an informed choice about how much response depth to consume before answering. Use when the user explicitly wants to control response length, depth, or token budget, or mentions "short version", "brief answer", "detailed answer", "token budget", or similar.
---
...
Use these calibration heuristics to estimate the prompt's token count:

- prose: `words × 1.3`
- code-heavy or mixed/code blocks: `chars / 4`

For mixed content, use the dominant content type.
