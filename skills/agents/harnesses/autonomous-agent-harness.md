...
description: Transform Claude Code into a fully autonomous agent system with persistent memory, scheduled operations, computer use, and task queuing. Use when the user wants continuous autonomous operation, scheduled tasks, or a self-directing agent loop.
---
...
Prefer dry-run plans and local queue files before enabling recurring or event-driven actions. Keep credentials, private workspace exports, personal datasets, and account-specific automations out of reusable artifacts.
...
mcp__scheduled-tasks__create_scheduled_task({
  ...
  prompt: "Review all open PRs. For each: check CI status, review changes, flag issues. Post summary to memory.",
