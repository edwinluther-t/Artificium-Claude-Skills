---
name: eval-harness
description: Formal evaluation framework for Claude Code sessions implementing eval-driven development (EDD) principles. Use when setting up pass/fail criteria, measuring agent reliability with pass@k metrics, or creating regression test suites for prompt or agent changes.
---
