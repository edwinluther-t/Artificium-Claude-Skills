---
name: fullstack-dev
description: Full-stack backend architecture and frontend-backend integration guide. Use when building full-stack apps, REST APIs with frontends, backend services, CRUD/chat/real-time apps, or hardening for production.
---
