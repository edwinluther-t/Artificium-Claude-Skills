...
description: Build a fully automated AI-powered data collection agent for any public source — job boards, prices, news, GitHub, sports, anything. Scrapes on a schedule, enriches data with a free LLM, stores results in Notion/Sheets/Supabase, and learns from user feedback. Use when the user wants to monitor, collect, or track any public data automatically.
---
