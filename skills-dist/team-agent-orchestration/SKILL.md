...
- The user mentions team orchestration, agent Kanban, squad, conductor, control pane, manager, multi-agent work, or desktop orchestrator.
...
2. **Pick execution mode**: single-agent, dynamic workflow mode, tmux, worktree fan-out, or external desktop orchestrator.
