...
description: Design task-local harnesses, eval gates, and reusable skill extraction for adaptive agent workflows. Use when a coding agent needs to generate or adapt a task-local harness instead of following a static command flow.
---
...
- The user mentions dynamic workflows, custom harnesses, harness-per-task, adaptive workflows, or dynamic workflow mode.
