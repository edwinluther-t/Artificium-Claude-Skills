...
Create favicons from emoji characters with smart suggestions.
...
python scripts/generate_favicons.py --emoji "💻" --emoji-bg "white" ./output all
```
...
- Warning: Issues to consider but not critical
