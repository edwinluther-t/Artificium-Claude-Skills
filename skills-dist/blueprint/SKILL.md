...
- **Zero runtime risk** — Pure Markdown skill. No hooks, no shell scripts, no executable code. Nothing runs on install or invocation beyond the native Markdown skill loader.
