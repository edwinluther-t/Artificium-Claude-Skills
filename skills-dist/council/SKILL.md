...
- the in-context voice (Architect)
- a Skeptic subagent
...
- use a knowledge-ops skill to store the lesson in the right durable location
- or update the relevant issue/ticket directly if the decision changes active execution truth
...
```text
Should we ship this feature as alpha now, or hold until the control-plane UI is more complete?
```
