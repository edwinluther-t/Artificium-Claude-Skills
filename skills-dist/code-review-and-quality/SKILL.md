...
Dispatch a code reviewer subagent to catch issues before they cascade. Give the reviewer precisely crafted context — never your session history. This keeps the reviewer focused on the work product.
...
**Instead:** Restate the technical requirement, ask clarifying questions, push back with reasoning if wrong, or just act.

**If feedback is unclear:** Stop. Do not implement anything. Clarify all unclear items first — items may be related, and partial understanding leads to wrong implementation.

**When to push back:**
- Suggestion breaks existing functionality
- Reviewer lacks full context
- Violates YAGNI (unused feature — grep the codebase first)
