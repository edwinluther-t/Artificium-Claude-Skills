---
name: context-budget
description: Audits Claude Code context window consumption across agents, skills, MCP servers, and rules. Use when session performance degrades, after adding many components, or when planning to add more and need to know available headroom.
---
