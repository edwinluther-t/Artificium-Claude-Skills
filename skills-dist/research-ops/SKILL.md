...
This is the operator wrapper around the research stack. It is not a replacement for `deep-research` or `market-research`; it tells you when and how to use them together.
...
- use fast web search for discovery
