...
description: Safely open-source any project through a 3-stage pipeline — fork, sanitize, and package. Use when preparing a private repo for public release, stripping secrets before publishing, or generating open-source packaging artifacts.
---
